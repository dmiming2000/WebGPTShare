...
def optimize_sentence(sentence):
    ...
    while True:
        try:
            ...
            i += 1
            print("Error occurred. Retrying in 10 seconds...")
            time.sleep(10)
            if i > 10:
                return False
...
# 示例用法
sentence = "宝宝取名生辰八字免费 锦航、奕然、嘉彦、梓原、谨丞、易天、溢昕 宝宝起名网免费:八字命理学、新派五格法、占星名学、奇门名字学 新乡景名源起名中心(中华隆取名网) 用好名字 提升个人气场 发展飞速 --品名网"
